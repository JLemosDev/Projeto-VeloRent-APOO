...
public class MenuVeiculo {
    ...
    public MenuVeiculo(VeiculoService service) {
    ...
    private void cadastrar() {
        ...
        try {
            Veiculo v = service.cadastrar(marca, modelo, placa, ano, categoria, valorDiaria);
            System.out.println("Veículo cadastrado com sucesso! " + v);
        } catch (Exception e) {
    ...
    private void editar() {
        ...
        try {
            Veiculo v = service.editar(id, marca, modelo, placa, ano, categoria, valorDiaria);
