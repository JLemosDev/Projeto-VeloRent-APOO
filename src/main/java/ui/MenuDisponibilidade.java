...
public class MenuDisponibilidade {
    ...
    public MenuDisponibilidade(DisponibilidadeService service, VeiculoService veiculoService, Usuario usuarioLogado) {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 3 -> {
                    ...
                    else System.out.println("Acesso restrito. Apenas Administradores podem excluir registros de disponibilidade.");
                }
                case 4 -> listar();
    ...
    private void cadastrar() {
        ...
        try {
            ...
            System.out.println("Disponibilidade registrada com sucesso!");
    ...
    private void excluir() {
        ...
        System.out.print("Tem certeza que deseja excluir este registro de disponibilidade? (1=Sim / 0=Não): ");
        if (Entrada.lerInt() != 1) { System.out.println("Operação cancelada."); return; }

        try {
            service.excluir(id);
            System.out.println("Registro de disponibilidade removido com sucesso!");
        } catch (Exception e) {
            System.out.println("Erro: " + e.getMessage());
        }
    }
    ...
    private void listar() {
        ...
        if (lista.isEmpty()) {
            System.out.println("Nenhuma disponibilidade registrada.");
        } else {
